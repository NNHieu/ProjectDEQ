...
class DEQLayer(nn.Module):
    ...
    def parse_cfg(self, cfg):
        ...
        self.b_solver = eval(cfg.b_solver)
    ...
    # def forward(self, x,  train_step=-1, compute_jac_loss=False, spectral_radius_mode=False, writer=None, **kwargs):
    #     # ----------------Setting up-------------------------------
    #     bsz = x.shape[0]
    ...
    #     # z1 = torch.zeros_like(x, requires_grad=False)
    #     # ----------------Computation part-------------------------------
    #     if not deq_mode:
